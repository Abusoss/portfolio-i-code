...
function Presentation<T>(props: T & PresentationType['Portrait'] & AProposType) {
   return (
      <div className="grid grid-flow-row grid-cols-1 gap-y-20 md:gap-0 md:grid-flow-col md:grid-cols-[0.1fr,2.8fr,0.1fr] lg:grid-cols-[0.25fr,2.5fr,0.25fr]  2xl:grid-cols-[0.625fr,1.75fr,0.625fr] w-full relative items-center justify-center">
         <div className="grid col-start-2 grid-flow-row gap-20">
            <motion.section
               initial={{ opacity: 0, y: 50 }}
               whileInView={{ opacity: 1, y: 0 }}
               transition={{ duration: 0.6, delay: 0.5 }} className='snap-start grid grid-flow-row gap-5 justify-items-center place-content-center md:h-[100vh]'>
            ...
            <section className='overflow-hidden grid grid-flow-row md:grid-flow-col gap-5 justify-items-center place-content-center md:h-[100vh] snap-start'>
               <motion.div
