...
const { NEXT_PUBLIC_API_URL,NEXT_PUBLIC_GRAPHQL, NEXT_PUBLIC_DOMAIN, NEXT_PUBLIC_DOMAIN_DATA_API, DOMAIN, DOMAIN_DIRECTUS, NEXTAUTH_URL, NEXT_PUBLIC_NEXTAUTH_URL, S3_URL, JWT_SECRET, S3_BUCKET_NAME, S3_BUCKET_REGION , NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME } = process.env;
